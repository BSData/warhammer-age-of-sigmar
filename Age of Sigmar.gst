...
<gameSystem id="e51d-b1a3-75fc-dc33" revision="2" battleScribeVersion="1.15" name="Age of Sigmar" books="The General&apos;s Handbook" authorName="https://gitter.im/BSData/" authorContact="@BSData" authorUrl="https://github.com/BSData/warhammer-age-of-sigmar" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <forceTypes>
  ...
  <profileTypes>
    ...
    <profileType id="f71f-b0a4-730e-ced3" name="Command Ability">
      <characteristics>
    ...
    <profileType id="90d1-a434-348d-a861" name="Wound Table">
      <characteristics>
    ...
    <profileType id="f55d-ee3a-1597-110f" name="Unit (Mage)">
      <characteristics>
    ...
    <profileType id="c137-4d1f-9d1a-524d" name="Allegience Ability">
      <characteristics>
